...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        [SerializeField] private Image m_Selection = null;                                             // Reference to the image who's fill amount is adjusted to display the bar.
        //[SerializeField] private VRInput m_VRInput;                                           // Reference to the VRInput so that input events can be subscribed to.
        [SerializeField] private Megamap.WallTarget m_WallTarget;   // Reference to the WallTarget so that input events can be subscribed to.
